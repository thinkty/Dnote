        ...
        return (
            ...
            >
                <Card>
                                ...
                                >
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25" width="30px" height="30px">
                                            <line x1="10" y1="10" x2="15" y2="10" stroke="#6698FA" strokeWidth="5" />
                                            <line x1="10" y1="20" x2="15" y2="20" stroke="#6698FA" strokeWidth="5" />
                                        </svg>
                                    </IconButton>
                                </Tooltip>
                                <Menu
                    ...
                    {this.state.reference === "" ? <div/> : <DialogActions><Reference link={this.state.reference}/></DialogActions>}
                </Card>

                <Dialog 
                open={this.state.isEditNote}
                onClose={() => {this.editNote(); this.toggleSubmenu()}}
                >
                    <DialogTitle>
                        <Typography
                        >
